-- Migration: 20260101000003_force_function_update.sql
-- Description: Re-applying the function security fixes and logic corrections to ensure they are propagated.
-- (Previous migration might have been skipped if already marked as applied)
...
-- 2. SETUP STORAGE SECURITY
-- (Re-applying policies to be safe)
