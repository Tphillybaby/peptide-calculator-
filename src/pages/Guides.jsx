...
const Guides = () => {
    return (
        <>
            <SEO
                title="Peptide Guides | Protocols, Safety & Best Practices"
                description="Expert-curated peptide guides covering protocols, safety, storage, and best practices for beginners and advanced users."
                canonical="/guides"
            />
